...
<script src="owl_carousel/owl-carousel/owl.carousel.js"></script>
  ...
  <section id="container" class="">
      ...
      <!--header end--> <form class="well form-horizontal" action=" " method="post"  id="contact_form">
<fieldset>
...
<div class="form-group">
  <label class="col-md-4 control-label">Family Income</label>  
    ...
    <div class="input-group">
        <span class="input-group-addon"><i class="glyphicon glyphicon-home"></i></span>
  <input name="family-income" placeholder="Family Income" class="form-control" type="text">
    </div>
  </div>
</div>
